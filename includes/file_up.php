  ...
  <li class="breadcrumb-item active">File Upload</li>
      ...
      <hr>
			...
			<div class="form-group"><label class="btn btn-default file" style="display:block;margin:0 auto;cursor: pointer;">Click here to select file <input type="file" style="display: none;" name="file" id="file"></label></div>
				<div class="form-group"><input type="submit" name="submit" class="btn btn-default btn-block" value="submit" id="submit-button" style="display:block;margin:0 auto;cursor: pointer;"><div>
      ...
      <a href="https://www.owasp.org/index.php/Unrestricted_File_Upload">On Owasp</a><br>
      <a href="https://www.w3schools.com/php/php_file_upload.asp">On w3schools</a><br>
      <a href="http://guardiran.org/search/?&q=file%20upload&eitherTermsOrTags=or&sortby=relevancy">On GuardIran Security Team<span class="badge badge-secondary">Persian</a><br>
