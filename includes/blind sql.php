...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Blind SQL Injection</li>
      ...
      <?php
				...
				$conn = new mysqli($_sv, $_user, $_pass, $dbnamegi);
      ...
      <a href="https://www.owasp.org/index.php/Blind_SQL_Injection">On Owasp</a><br>
      <a href="http://securityidiots.com/Web-Pentest/SQL-Injection/Blind-SQL-Injection.html">On Security Idiots</a><br>
      <a href="https://www.exploit-db.com/papers/13045/">On Exploit-db</a><br>
      <a href="http://guardiran.org/search/?&q=blind%20sql%20injection&eitherTermsOrTags=or&sortby=relevancy">On GuardIran Security Team<span class="badge badge-secondary">Persian</a><br>
