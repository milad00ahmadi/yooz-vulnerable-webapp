...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Cross Site Request Forgery</li>
      ...
      <hr>
				...
				<form class="form-horizontal" action="" method="get">
				<input type="text" style="display:none;" value="csrf" name="vuln">
				<div class="form-group"><label></label><select class="form-control" name="post"><option>Post 1</option><option>Post 2</option><option>Post 3</option><option>Post 4</option><option>Post 5</option></select></div>
				<div class="form-group"><input type="submit" class="btn btn-default" value="Delete" style="display:block;margin:0 auto"><div>
				</form>
				<hr/>
				<br/><br/>
				<?php
	...
	?>
      ...
      <a href="https://www.owasp.org/index.php/Cross-Site_Request_Forgery_(CSRF)">On Owasp</a><br>
      <a href="https://www.sitepoint.com/preventing-cross-site-request-forgeries/">On Site Point</a><br>
      <a href="http://guardiran.org/search/?&q=csrf&eitherTermsOrTags=or&sortby=relevancy">On GuardIran Security Team<span class="badge badge-secondary">Persian</a><br>
