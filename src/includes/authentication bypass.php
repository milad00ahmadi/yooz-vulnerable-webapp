...
<div class="col-sm-9 top-margin-2">
	...
	<form class="form-horizontal" action="" method="post">
		...
		if (isset($_POST['submit'])) {
			$connect = new mysqli($_sv, $_user, $_pass, $_dbnamegi);
		...
		<hr>
		<a href="http://www.sqlinjection.net/login/">sqlinjection.net</a><br>
		<a href="https://www.owasp.org/index.php/Testing_for_Bypassing_Authentication_Schema_(OTG-AUTHN-004)">Owasp</a><br>

		<a href="https://www.exploit-db.com/papers/14340/">Exploit-db</a><br>
		<a href="http://guardiran.org/search/?&q=Authentication%20bypass&eitherTermsOrTags=or&sortby=relevancy">GuardIran Security Team<span class="badge badge-secondary">Persian</a><br>
