...
<div class="col-sm-9 top-margin-2">
	...
	<div class="container-fluid">
		<form class="form-horizontal" action="" method="post">
			...
			<div class="form-group"><input type="submit" class="btn btn-default" value="submit" style="display:block;margin:0 auto">
				<div>


		</form>
		<div class="form-group"><a href="?vuln=xss_stored&xss_clear=true" style="color:#FFF;"><button class="btn btn-danger" style="display:block;margin:10px auto;color:#FFF !important">Clear Table</a></button>
			<div>
				<hr />
